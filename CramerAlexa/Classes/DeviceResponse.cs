...
namespace CramerAlexa.Hue.Classes
{
    public class DeviceResponse
    {
        ...
        public static DeviceResponse createResponse(String name, String id, bool isOn, long percentage)
        {
            Console.WriteLine("Creating a device response object with name[{0}], id [{1}].", name, id);
            ...
            deviceState.bri = (int)percentage;
